// Package api holds the shared annotation, label, and status types used by
// the openshift-acme controller and exposer to coordinate certificate
// provisioning on Routes.
package api
